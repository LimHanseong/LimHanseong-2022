...
int main()
{
	...
	int i, j = 0;
	// Program description
	printf("Hello, this is a program that solves a system of equations with three unknowns using the Cramer's rule. Enter 1 if you want to continue or any keys if you want to exit.\n:");
	scanf_s("%d", &j);
	if (j == 1)
	{
